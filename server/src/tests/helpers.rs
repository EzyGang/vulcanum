...
pub async fn insert_project_config_for_team(
    ...
    sqlx::query!(
        "INSERT INTO project_configs (id, team_id, external_project_id, integration_type, prompt_template) VALUES ($1, $2, $3, 'kaneo', 'Review the PR')",
        id,
        team_id,
        external_project_id,
    )
...
pub async fn insert_project_config_with_provider(
    ...
    sqlx::query!(
        "INSERT INTO project_configs (id, team_id, external_project_id, integration_type, provider_id, prompt_template) VALUES ($1, $2, $3, 'kaneo', $4, 'Review the PR')",
        id,
        DEFAULT_TEAM_ID,
        external_project_id,
        provider_id,
