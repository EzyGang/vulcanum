...
use crate::db::work_runs::queries::implementation_followups::{
    FinishFollowupRequestParams, InsertFollowupRequestParams,
};
...
impl WorkRunsRepository {
    ...
    pub async fn finish_github_implementation_followup<'c, Q>(
        &self,
        db: Q,
        params: FinishFollowupRequestParams<'_>,
        ...
        sqlx::query!(
            r#"UPDATE github_implementation_followup_requests
               SET external_task_ref = COALESCE($2, external_task_ref),
                   ...
                   ambiguous_task_refs = $6
               WHERE delivery_id = $1"#,
            params.delivery_id,
            params.external_task_ref,
            params.work_run_id,
            params.ticket_created,
            params.outcome,
            params.ambiguous_task_refs,
        )
        .execute(db)
        .await?;
