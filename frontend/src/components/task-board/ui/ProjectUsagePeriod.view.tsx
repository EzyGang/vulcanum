...
export const ProjectUsagePeriodView = ({
  ...
  <div class='grid min-w-0 gap-3 p-4 lg:grid-cols-[minmax(0,1fr)_minmax(10rem,0.75fr)] lg:items-start lg:gap-4'>
    ...
    {data.emptyMessage ? (
      <p class='text-sm text-text-muted lg:col-span-2'>{data.emptyMessage}</p>
    ) : (
      <div
        role='group'
